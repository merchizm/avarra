...
const records = {
  ...
  'kara-muhur-adalari': [17, '260–410 bin · sözleşme ve filo mevsiminde 600 bine yaklaşır', '260–410k · approaches 600k in contract and fleet season', 'Dış denizlerde ağırlık, ayar ve askerî ödeme standardını tutan ada devleti.', 'Outer-sea island state maintaining weight, fineness, and military-payment standards.'],
  'kul-esigi': [18, '90–145 bin · eğitim, tahliye ve onarım mevsimlerinde 220 bine yaklaşır', '90–145k · approaches 220k during education, evacuation, and repair seasons', 'Kül Şövalyeleri’nin ada yurdu; açık eğitim, sığınma, tanıklık ve onarım merkezi.', 'Island home of the Ash Knights: open education, refuge, witness, and repair.'],
