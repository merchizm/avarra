...
const states = [
  ...
  ["Saar'ın İki Ejderha Tacı", 'Two Dragon Crowns', 'saarin-iki-ejderha-taci', 'two-dragon-crowns.jpg'],
  ['Dokuz Fener Birliği', 'Nine Lantern Union', 'dokuz-fener-birligi', 'nine-lantern-union.jpg'],
  ...
  ['Sis Adaları Cumhuriyeti', 'Mist Isles Republic', 'sis-adalari-cumhuriyeti', 'mist-isles-republic.jpg'],
  ['Altıngüneş Krallığı', 'Goldensun Kingdom', 'altin-gunes-kralligi', 'goldensun-kingdom.jpg'],
  ...
  ['Kış Ambarları Serbest Şehri', 'Free City of Winter Granaries', 'kis-ambarlari-serbest-sehri', 'kis-ambarlari.jpg'],
